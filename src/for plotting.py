...
# plt.legend()
# plt.savefig(directory+'/plots/atm_flux.png', dpi = 300, bbox_inches='tight')
...
# plt.plot([0,18], [0,18], 'k-') #1:1 line
# plt.rcParams["figure.figsize"] = [6,4] #update figure size
# plt.plot(updated_texp_50,updated_texp_250, 'o', c = 'darkgreen', label = "50 ka bins")
# plt.plot(updated_texp_1ma, updated_texp_250, '^', c = 'darkblue', alpha = 0.6, label = "1 Ma bins")
# #plt.plot(updated_texp_past_50, updated_texp_past_250, 'x', c = 'darkgreen', label = '40-65 Ma')
# plt.legend(frameon = True,facecolor='white',framealpha=1, fontsize = 10)
# plt.xlabel('Exposure Age [Ma]', fontsize = 10)
# plt.ylabel('Exposure Age [Ma] 250 ka bins', fontsize = 10)
# plt.savefig(Read.directory+'/plots/binsize_comparison.png', dpi = 300, bbox_inches='tight')
...
# plt.savefig(directory+'/plots/sf_varying_const_india.png', dpi = 300, bbox_inches='tight')
...
# pn_cpx = neutron_spallation.pn_df.iloc[0]
# pn_cpx.to_csv(directory+'/plots/pn_cpx.csv') 
# pp_cpx = proton_spallation.pp_df.iloc[0]
# pp_cpx.to_csv(directory+'/plots/pp_cpx.csv') 


# pn_qtz = neutron_spallation.pn_df.iloc[0]
# pn_qtz.to_csv(directory+'/plots/pn_qtz.csv') 
# pp_qtz = proton_spallation.pp_df.iloc[0]
# pp_qtz.to_csv(directory+'/plots/pp_qtz.csv') 
